...
exports.default = {
    ...
    handler: (params, context) => __awaiter(this, void 0, void 0, function* () {
        ...
        projectController_1.ProjectController.generateFunction(context, {
            type: Extensions_1.ExtensionType.task,
            name,
            mocks,
            syntax,
            silent,
    ...
    describe: translations_1.translations.i18n.t('generate_task_describe'),
    builder: (args) => args
        .usage(translations_1.translations.i18n.t('generate_task_usage'))
        .option('schedule', {
        alias: 'sch',
        describe: translations_1.translations.i18n.t('generate_task_schedule_describe'),
        type: 'string',
    })
        .option('mocks', {
        alias: 'x',
