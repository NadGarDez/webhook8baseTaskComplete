...
exports.passwordLogin = (params, context) => __awaiter(this, void 0, void 0, function* () {
    ...
    const data = {
        email: params.email ? params.email : yield promptEmail(),
        password: params.password ? params.password : yield promptPassword(),
    };
    context.spinner.start(context.i18n.t('login_in_progress'));
    const result = yield context.request(GraphqlActions_1.GraphqlActions.login, { data: { email: data.email, password: data.password } }, {
