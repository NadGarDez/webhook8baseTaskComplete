...
(function (Utils) {
    ...
    Utils.archiveToMemory = (directories, context) => __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            ...
            directories.forEach(sourcePath => {
                ...
                context.logger.debug('archive files from directory = ' +
                    sourcePath.source +
                    ' dist = ' +
                    sourcePath.dist +
                    ' is file = ' +
    ...
    Utils.commandDirMiddleware = (commandsDirPath) => (commandObject, pathName) => {
        ...
        if (fileDepth <= 2 && !!cmd.command) {
            return Object.assign({}, cmd, { handler: commandController_1.CommandController.wrapHandler(cmd.handler, translations_1.translations) });
        }
    };
